                ...
                if(response.data == "error"){
                    ...
                    (async() => {
                        ...
                        for(let i = 0 ; i < response.data.blue.length ; ++i){
                            ctx.beginPath();
                            ctx.arc(225, 250+(i*200), 35, 0, 2 * Math.PI);
                            ...
                            ctx.fillText(response.data.blue[i].level, 225, 250+(i*200));
                            ...
                            ctx.drawImage(border, 160, 185+(i*200), 130, 130);
                            ctx.font = '40px Arial';
                            ctx.fillStyle = '#FFFFFF';
                            ctx.textAlign = "left";
                            ctx.textBaseline = "middle"; 
                            ctx.fillText(response.data.blue[i].pseudo, 300, 250+(i*200));
                            ctx.font = '25px Arial';
                            ctx.fillStyle = '#FFFFFF';
                            ctx.textAlign = "center";
                            ctx.textBaseline = "middle"; 
                            ...
                            ctx.textAlign = "center";
                            ctx.textBaseline = "middle"; 
                            ctx.fillText(div_name+" "+response.data.blue[i]["palier"], 881.25, 340+(i*200));
                            ...
                            ctx.drawImage(mastery, 825, 190+(i*200), 112.5, 127.5);
                            
                        }
                        for(let i = 0 ; i < response.data.red.length ; ++i){
                            ctx.beginPath();
                            ctx.arc(1775, 250+(i*200), 35, 0, 2 * Math.PI);
                            ctx.fillStyle = "#000000";
                            ctx.fill();
                            ctx.font = 'bold 25px Arial';
                            ctx.fillStyle = '#FFFFFF';
                            ctx.textAlign = "center";
                            ctx.textBaseline = "middle"; 
                            ctx.fillText(response.data.red[i].level, 1775, 250+(i*200));
                            var level = socialBorder(response.data.red[i].level);
                            var border = await Canvas.loadImage('http://localhost/ligta/images/border/social/theme-'+level+'-social-border.png');
                            ctx.drawImage(border, 1710, 185+(i*200), 130, 130);
                            ctx.font = '40px Arial';
                            ctx.fillStyle = '#FFFFFF';
                            ctx.textAlign = "right";
                            ctx.textBaseline = "middle"; 
                            ctx.fillText(response.data.red[i].pseudo, 1700, 250+(i*200));
                            ctx.font = '25px Arial';
                            ctx.fillStyle = '#FFFFFF';
                            ctx.textAlign = "center";
                            ctx.textBaseline = "middle"; 
                            ...
                            ctx.textAlign = "center";
                            ctx.textBaseline = "middle"; 
                            ctx.fillText(div_name+" "+response.data.red[i]["palier"], 1118.75, 340+(i*200));
                            ...
                            ctx.drawImage(mastery, 1062.5, 190+(i*200), 112.5, 127.5);
                        }
